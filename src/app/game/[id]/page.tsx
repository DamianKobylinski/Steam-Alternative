...
export default async function GamePage({
  ...
  return (
    <div className="p-6 lg:p-10 min-h-screen">
      ...
      <Link
        href={backUrl}
        className="inline-flex items-center gap-3 text-[#2292ee] text-2xl py-5 hover:translate-x-2 transition-transform"
      >
        <MoveLeft size={32} />
      ...
      <div
        ...
        className="relative h-[500px] lg:h-[600px] w-full rounded-xl overflow-hidden"
      ></div>

      {/* Game Cover + Info Overlay */}
      <div className="p-12 lg:p-12">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-2 items-start">
          {/* Cover Image */}
          <div
            style={{
              backgroundImage: `url(${
            ...
            className="h-80 w-64 lg:h-96 lg:w-72 rounded-xl shadow-2xl border-4 border-white/20"
          />
